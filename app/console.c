 ...
 *
 *  - Added #include <stdio.h> to resolve a warning message
 *  - Changed __read() to _read() consistent with newlib-nano
 *  - Changed __write() to _write() consistent with newlib-nano
 */
